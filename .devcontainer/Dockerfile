...
RUN apt-get update \
    ...
    && pip --disable-pip-version-check --no-cache-dir install hummingbird_ml[extra,onnx] \
    && pip --disable-pip-version-check --no-cache-dir install treelite treelite_runtime \
    #
